...
cc65\bin\ca65 -o temp\tapesys_boot.o -g a2f\tapesys_boot.s
@IF ERRORLEVEL 1 GOTO error

cc65\bin\ca65 -o temp\a2f_demo.o -g a2f_demo.s
@IF ERRORLEVEL 1 GOTO error

cc65\bin\ld65 -o temp\a2f_demo_tape.bin -m temp\a2f_demo_tape.map --dbgfile temp\a2f_demo_tape.dbg -C a2f_tape.cfg temp\tapesys_boot.o temp\a2f_demo.o
@IF ERRORLEVEL 1 GOTO error
